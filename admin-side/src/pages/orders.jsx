...
export default function Orders() {
  ...
  const filteredOrders = orders.filter((o) => {
    ...
    const matchesSearch = o.userEmail?.toLowerCase().includes(search.toLowerCase()) ||
              ...
              <tbody>
                {filteredOrders.map((order) => (
                  ...
                  >
                    ...
                    <td style={styles.td}>
                      <span style={styles.price}>₱{order.grandTotal}</span>
                    </td>
                    <td style={styles.td}>
            ...
            <div style={styles.detailContent}>
              ...
              <div style={styles.detailSection}>
                <div style={styles.priceRow}>
                  ...
                  <p style={styles.priceValue}>₱{selectedOrder.totalPrice}</p>
                </div>
                <div style={styles.priceRow}>
                  <p style={styles.priceLabel}>Shipping Fee</p>
                  <p style={styles.priceValue}>₱{selectedOrder.shippingFee}</p>
                </div>
                <div style={styles.priceDivider} />
                <div style={styles.priceRow}>
                  <p style={styles.priceTotalLabel}>Total</p>
                  <p style={styles.priceTotalValue}>₱{selectedOrder.grandTotal}</p>
                </div>
              </div>
                  ...
                  {statusOptions.map((status) => (
                    <button
                      ...
                      style={{
                        ...
                        border: selectedOrder.status === status
                          ? `2px solid ${statusColors[status]?.color}` : '2px solid transparent',
                      }}
