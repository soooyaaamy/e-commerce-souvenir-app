...
export default function BottomModal({ visible, product, onClose, mode }: Props) {
  ...
  const unitPrice = parseInt(product.price.replace("₱", ""));
  ...
  onClose();
  if (mode === "cart") {
    Alert.alert("Added to Cart! 🛒", `${product.name} (x${quantity}) has been added to your cart!`);
  } else {
      ...
      >
        ...
        <View style={styles.quantitySection}>
          ...
          <View style={styles.quantityControls}>
            ...
            >
              <Ionicons name="add" size={20} color={quantity >= product.stock ? "#ccc" : "#5C4033"} />
            </TouchableOpacity>
          </View>
        </View>
